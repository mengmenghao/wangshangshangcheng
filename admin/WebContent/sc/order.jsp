...
<%if(shopcar!=null){
    ...
    <input name="kc" type="hidden" id="xh" size="60" value="<%=i%>" >
      <tr class="xx">
        ...
        <td width="150" class="cloor"><div align="left">
		<input type="text" value=num id="num" class="inputs"></div></td>
      <td width="103" class="cloor">
        <div align="left"><a href="goodslist.jsp?id=<%=shopcar.get(i).getGoods_id()%>">删除</a></div></td>
      </tr> 
